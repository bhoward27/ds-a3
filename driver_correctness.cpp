...
int main(int argc, char *argv[])
{
    ...
    options.add_options("custom", {
                                    ...
                                    // TODO: Add above back in.
                                      {"input_file", "Input file path for random numbers file", cxxopts::value<std::string>()->default_value("/home/ben/Documents/SFU/cmpt-431/assignments/3/provided_code/default_input_file/rand_10M")},
                                  });
